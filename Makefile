...
## C toolchain (e.g. i686-w64-mingw32-gcc); set CC accordingly before running. --kill-at keeps
## the stdcall export undecorated so CNG resolves GetKeyStorageInterface by its plain name.
build-windows-x86:
